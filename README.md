...
| Data  | Responsável(is) | Módulo                                                          | Descrição                                                                                                                                                                                             |
| ----- | --------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 15/09 | Lucas           | **React + Tailwind**                                            | Introdução ao React (componentes, props, estado), estrutura de um projeto front-end e uso do Tailwind CSS para estilização rápida e responsiva.                                                       |
| 16/09 | Igor            | **Fundamentos do Linux**                                        | Comandos básicos, navegação no terminal, permissões de arquivos, edição com nano/vim, boas práticas no ambiente de desenvolvimento.<br>💡 *Sugestão: use Linux nativo; no Windows, Git Bash ou WSL.*  |
| 17/09 | Brenda & Bia    | **Ágil**                                                        | Visão geral de metodologias ágeis (Scrum, Kanban), fluxo de trabalho no NExTI, boas práticas de comunicação, padrões de documentação e normas internas.                                               |
| 17/09 | Brenda & Bia    | **Cultura & Comunicação no NExTI**                              | Valores do time, canais (Discord, e-mail, repositórios), etiqueta em reuniões, como dar feedback construtivo.                                                                                         |
| 17/09 | Caio            | **Git & Versionamento**                                         | Conceitos básicos de Git, comandos essenciais (`clone`, `commit`, `push`, `pull`), criação e gerenciamento de branches, fluxo Gitflow e práticas colaborativas no GitHub.                             |
| 18/09 | Ian             | **UI/UX**                                                       | Princípios de design de interface, experiência do usuário, usabilidade, consistência visual, wireframes e prototipagem.                                                                               |
| 19/09 | Igor            | **Docker e Makefile**                                           | Introdução ao Docker, criação de imagens e containers, uso de `docker-compose` e Makefiles para automação.                                                                                            |
| 22/09 | Lucas           | **REST API**                                                    | Conceitos de API REST: endpoints, métodos HTTP, status codes e boas práticas de backend.                                                                                                              |
| 22/09 | Caio            | **Swagger**                                                     | Documentação de APIs com Swagger/OpenAPI, leitura e criação de especificações, exemplos interativos para consumo de endpoints.                                                                        |
| 24/09 | Ícaro           | **Database SQL**                                                | Introdução a bancos de dados relacionais, comandos SQL (SELECT, INSERT, UPDATE, DELETE), modelagem e relacionamentos.                                                                                 |
| 24/09 | Ícaro           | **Integração Contínua / Deploy**                                | Noções básicas de CI/CD (GitHub Actions, GitLab CI), fluxo de entrega até produção.                                                                                                                   |
| 24/09 | Francisco | **Segurança e Boas Práticas**                                   | Versionamento seguro, tratamento de secrets (`.env`), revisão de código, LGPD, backups.                                                                                                               |
